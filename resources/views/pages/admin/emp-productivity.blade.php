        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Today's Productivity > 
                        {{$newLead = DB::table('leads')
                        ->whereDate('leads.updated_at','>=', $date)
                ...
                <div class="card-box">  
                     ...
                     <div class="row">
                      <form action="{{ url('/from-productivity-to') }}" method="get">
                          ...
                          <div class="col-md-12 d-flex">
                              <div class="col-md-6">
                                  <label for="" style="font-size: 11px">From</label>
                                  <input type="date" class="form-control" name="from" max="<?= date('Y-m-d') ?>" required 
                                      value="{{ old('from') }}">
                              </div>
                              <div class="col-md-6">
                                  <label for="" style="font-size: 11px">To</label>
                                  <input type="date" class="form-control" id="to_date" max="<?= date('Y-m-d') ?>" name="to" required 
                                      value="{{ old('to') }}">
                              </div>
                    ...
                    <div class="table-responsive" style="margin-top: 0px"> 
                        ...
                        id="demo-foo-filtering">
                            ...
                            <thead >
                                <tr> 
                                    <td class="text-center">Total Productivity</td>  
                                ...
                                @else
                                    <td class="text-center">
                                        {{ 
                                            $newLead = DB::table('leads')
                                                ->whereDate('leads.created_at', '>=', $date)
                                                // ->where('assign_employee_id', $empDeshboard['emaployee_id']) // Uncomment if needed
                                                ->where('created_by', '!=', $empLead->assign_employee_id)
                                                // ->where('lead_status', 1) // Uncomment if needed
                                                ->count()
                                        }}
                                    </td>
                                @endif
                                ...
                                @foreach ($employeeData as $empDeshboard)
                                    ...
                                    <tr class="text-center">
                                        @php
                                            ...
                                            $to1 = isset($to) ? $to : Carbon\Carbon::now();
                                    ...
                                    <td>{{ 
                                       $TotalEmpLeads = DB::table('leads') 
                                            ->where('assign_employee_id', $empDeshboard['emaployee_id'])
                                             ->count()  
                                             }}
                                    </td>
                                    <td>{{ 
                                      $EmpLeadsCommonPoll = DB::table('leads') 
                                           ->where('assign_employee_id', $empDeshboard['emaployee_id'])
                            ...
                            <thead >
                                <tr> 
                                    ...
                                    <td class="text-center">
                                       ...
                                       @if ($empLead == null)
                                        <td class="text-center">
                                            {{-- Handle the case where $empLead is null --}}
                                            {{ 0 }}
                                        </td>
                                    @else
                                        <td class="text-center">
                                            {{ 
                                                $matchingRecords = DB::table('leads')
                                                    ->whereDate('leads.created_at', '>=', $date)
                                                    // ->whereColumn('created_by', '=', 'assign_employee_id') // Uncomment if needed
                                                    ->where('created_by', $empLead->assign_employee_id)
                                                    // ->where('assign_employee_id', $empDeshboard['emaployee_id']) // Uncomment if needed
                                                    ->count()
                                            }}
