        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Free Search Data</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="datatable-buttons" class="table table-centered table-nowrap table-hover mb-0" data-placement="top">
                                ...
                                <tbody>
                                    @foreach ($searchResults as $key => $lead)
                                     @php
                                        ...
                                        >
                                            ...
                                            <td style="min-width: 180px; max-width: 180px; white-space: normal">
                                                ...
                                                <a href="#" class="text-body font-weight-semibold updateStatus"
                                                    value="{{ $lead->lead_name }}"  data-toggle="modal"
                                                    ...
                                                    <i class="fas fa-user-plus text-info" title="Follow Up Buddy" @if ($lead->co_follow_up  !== null && $lead->is_featured == 1)
                                                        @else
                                                        style="display:none;" @endif>

                                                        <i class="fa solid fa-handshake text-primary"
                                                                            title="Channel Partner"
                                                                            @if ($lead->rwa  !== null && $lead->is_featured == 1)
                                                        @else
                                                    ...
                                                    <i class="fa solid fa-handshake text-primary"
                                                        ...
                                                        <i class="fas fa-user-plus text-info" title="Follow Up Buddy" @if ($lead->co_follow_up !== null)
                                                            @else
                                                            style="display:none;" @endif>
                                                    <span>
                                            ...
                                            <td>
                                                @php
                                                     ...
                                                     $lastContected = \Carbon\Carbon::parse($lead->last_contacted)->format('d-M-Y');

                                                    //  dd($lastContected);

                                                @endphp
                                                <a href="http://agent.drivesu.in/iconnect/?authkey=AxjSB12ioewI91j&custid=16405&passwd=IB0118T2&phone1={{$lead->official_phone_number}}&phone2={{ $lead->contact_number  }}">
                                                    <i class="fa fa-phone" aria-hidden="true"></i> 
                                                </a>
                                                 <a class="text-muted"
                                                 href="tel: {{$lead->country_code}}{{ $trimNumber }}"> 

                                                 {{$lead->country_code}}{{ $trimNumber }}</a>
                                             <a
                                            ...
                                            <td> 
                                                ...
                                                {{ "Not Need" }}
                                             @else
                                                    {{ \Carbon\Carbon::parse($lead->last_contacted)
                                                    ->format('d-M-Y')}}  
                                                     {{-- {{ $lead->last_contacted  }}    --}}
                                                @endif
                                            ...
                                            <td>
                                                @if ($lead->next_follow_up_date == null)
                                                    {{ "Not Need" }}
                                                @else
                                                {{\Carbon\Carbon::parse($lead->next_follow_up_date)
                                                ->format('d-M-Y H:i:s')  }}
                        ...
                        {{-- @if (isset($currentUrl) != url('/common-pool')) 
