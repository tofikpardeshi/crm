        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Builder Details</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                ...
                                <form method="post" action="{{ route('update-builder', $BuilderDetails->id) }}">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input type="text" placeholder="Sales Person Name" name="team_name"
                                                        class="form-control" value="{{ $BuilderDetails->team_name }}" readonly>
                                                </div> 
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input type="text" placeholder="Contact Number"
                                                        ...
                                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                                        pattern="[1-9]{1}[0-9]{9}"
                                                        value="{{ $BuilderDetails->alternate_contact_number_team }}" readonly>
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input type="text" name="team_email" class="form-control"
                                                        value="{{ $BuilderDetails->team_email }}" readonly>
                                                </div> 
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input type="text" name="saler_person_alt_email" class="form-control"
                                                        value={{ $BuilderDetails->saler_person_alt_email }} readonly>
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            @endphp
                                            <div class="form-group mb-3">
                                                <label for="example-email">Name of Developer <span
                                                        class="text-danger">*</span></label>
                                                <select name="name_of_developer" id="name_of_developers"
                                                    data-style="btn-light" onchange="isBuilderSelected(this);"
                                                    class="selectpicker">
                                                    <option value="" selected>Select</option>
                                                    @foreach ($builders as $builder)
                                                        @if ($builder->id == $BuilderDetails->name_of_developer)
                                                            <option value="{{ $builder->id }}" selected disabled>
                                                                {{ $builder->name_of_developer }}</option>
                                                        @else
                                                            <option value="{{ $builder->id }}" disabled>
                                                                {{ $builder->name_of_developer }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input type="date" id="datepicker" name="date_of_birth"
                                                        ...
                                                        value="{{ $BuilderDetails->date_of_birth }}" readonly>
                                        ...
                                        <div class="col-lg-12" >
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control" name="remark" id="exampleFormControlTextarea1" rows="4" readonly>{{ $BuilderDetails->remark }}</textarea>
